...
with st.sidebar:
    ...
    #メディアプレーヤーのURLを定義します。
    media_url = st.text_input("Media URL", value="https://www.youtube.com/watch?v=CuU9q2VKOyc")
...
if "data" not in st.session_state:
    st.session_state.data = Path("C:\\Users\\S138563\\levleup\\study\\Streamlit\\data.json").read_text()
